...
void addOSModuleNativeWords(Interpreter& interp) {
    interp.defineNativeWord(U"READL", readLineOp);
    interp.defineNativeWord(U"READFI", readFileOp);
    interp.defineNativeWord(U"WRTFI", writeFileOp);
    interp.defineNativeWord(U"WRTLN", printlnStrOp);
    interp.defineNativeWord(U"WRT", printStrOp);
    interp.defineNativeWord(U"GLOBAL", globOp);
    interp.defineNativeWord(U"EXECT", execOp);
    interp.defineNativeWord(U"EXT", exitOp);
