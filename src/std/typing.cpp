...
void addTypingNativeWords(Interpreter& interp) {
    ...
    interp.defineNativeWord(U"TONUMBER", toIntegerOp);
    interp.defineNativeWord(U"TOARRY", toArrayOp);
    interp.defineNativeWord(U"TOPLCHLD", toPlaceholderOp);
    interp.defineNativeWord(U"TOSPLCHLD", toSplicePlaceholderOp);
    interp.defineNativeWord(U"TOWORD", toWordOp);
    interp.defineNativeWord(U"TOWASSGN", toWordAssignOp);
    interp.defineNativeWord(U"TOWDECLARE", toWordDeclareOp);
    interp.defineNativeWord(U"TOSTR", toStringOp);
    interp.defineNativeWord(U"TONWORD", toNativeWordOp);
}
